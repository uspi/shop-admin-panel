...
export const getProducts = (
        ...
        return async (dispatch, getState) => {
            ...
            let data = productsAPI.getProductsAll()
    ...
    export const updateProduct = (
        ...
        return async (dispatch, getState) => {
            ...
            productsAPI.updateProduct(productId, updated, isSetCurrentTime)
            let data = productsAPI.getProductsAll()
    ...
    export const addProduct = (
        ...
        return async (dispatch, getState) => {
            ...
            productsAPI.addProduct(product, isSetCurrentTime)
            let data = productsAPI.getProductsAll()
    ...
    export const addproducts = (
        ...
        return async (dispatch, getState) => {
            ...
            productsAPI.addProducts(products, isSetCurrentTime)
            let data = productsAPI.getProductsAll()
    ...
    export const setProducts = (
        ...
        return async (dispatch, getState) => {
            ...
            productsAPI.setProducts(products, isSetCurrentTime)
            let data = productsAPI.getProductsAll()
